...
mkdir $worker_name
# ln -s  $glob_db ./$task_db_file # not needed, already done
...
python3 ../plan_descend_tip_task_y-Cl.py ./$task_db_file ../$result_file ../$glob_db
