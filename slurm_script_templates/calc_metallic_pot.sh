...
## BEWARE -- adjust the databases files, cube_head and cc - center dividing sample and tip inside the python file !!! ##

## mpi run bellow #
srun python3 mpi_create_Efield.py --mpi # -f "cube" (default) or "npy" or "both" #
## or comment above and uncomment the serial run here: #
#python3 mpi_create_Efield.py
