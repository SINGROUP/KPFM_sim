...
ss_1, energies, energy_interp_data, forces_1 = calc_force_curve_from_energy(result_db, x_tip, y_tip, V , ignore_first = options.z)
...
np.savetxt("energy_x{}_y{}_V{}.txt".format(x_tip, y_tip,V), energy_array)
np.savetxt("force_x{}_y{}_V{}_dE.txt".format(x_tip, y_tip,V), force_array_1)
if AtForces :
    np.savetxt("force_x{}_y{}_V{}.txt".format(x_tip, y_tip,V), force_array_2)
...
plt.savefig("EvsD_x{}_y{}_V{}.png".format(x_tip, y_tip,V))
if Visu:
    plt.show()
else:
    plt.close()
...
plt.savefig("FvsD_x{}_y{}_{}.png".format(x_tip, y_tip,V))
if Visu:
    plt.show()
else:
    plt.close()
