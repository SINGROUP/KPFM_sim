...
with results:
    ...
    if abs(V) > eps:
        ...
        cp2k_calc = cp2k_initializer.init_calc_potential_relax(V, external_pot=True)
    else:
        cp2k_calc = cp2k_initializer.init_calc_potential_relax()
    ...
    if abs(V) > eps:
        cp2k_calc = cp2k_initializer.init_calc_potential_relax(V)
    else:
        cp2k_calc = cp2k_initializer.init_calc_potential_relax()
